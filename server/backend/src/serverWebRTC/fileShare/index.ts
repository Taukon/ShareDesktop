...
export class FileTransfer {
  ...
  private isFileTransports(
    fileTransports: FileTransports | undefined,
  ): fileTransports is FileTransports {
  ...
  public async establishRecvFile(
    ...
    const recvTransport = this.getRecvFileTransport(fileTransferId);
    const fileProducerId =
      this.getSendFileTransport(fileTransferId)?.producer?.id;
